...
const invokeTransaction = async (channelName, chaincodeName, fcn, args, username, org_name, transientData) => {
    try {
        ...
        // const ccpPath =path.resolve(__dirname, '..', 'config', 'connection-hospital1.json');
        ...
        if (fcn == "CreateRegistry") {
            ...
            return `That function: ${fcn} does not exists`
        }

...
{
   "peer_name": "peer0.hospital1.tfm.com",
   "channelid": "mychannel",
   "use_couchdb":false,
...
async function main() {
    try {
        ...
        const walletPath = path.join(process.cwd(), '../../api-2.0/hospital1-wallet/');
        ...
        // const ccpPath = path.resolve(__dirname, '..', 'first-network', 'connection-hospital1.json');
        const ccpPath = '../../api-2.0/config/connection-hospital1.json'
